...
obj/main_0.o: ./main.cpp ./Polyweb/polyweb.hpp ./Polyweb/Polynet/polynet.hpp ./Polyweb/Polynet/secure_sockets.hpp ./Polyweb/Polynet/smart_sockets.hpp ./Polyweb/string.hpp ./Polyweb/threadpool.hpp
...
server: obj/main_0.o obj/server_0.o obj/client_0.o obj/string_0.o obj/polyweb_0.o obj/websocket_0.o obj/secure_sockets_0.o obj/polynet_0.o
...
clean:
	@printf '\033[1m[POLYBUILD]\033[0m Deleting server and obj...\n'
	@rm -rf server obj
